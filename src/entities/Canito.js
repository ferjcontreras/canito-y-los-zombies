...
export class Canito {
    ...
    _howlTimer = 0;
    _turnLean = 0;
    static BARK_DURATION = 0.26;
    static HOWL_DURATION = 1.05;
    ...
    update(dt, keys, colliders) {
        ...
        if (walking) {
            const setLeg = (leg, swing, lift, roll) => {
            ...
            if (sprinting) {
                ...
                this._blendRotation(this._head, -0.10 + frontReach * 0.08 - frontLoad * 0.18 + headVocal, -this._turnLean * 0.65 + Math.sin(this._phase * 0.7) * 0.04, 0.34);
                ...
                this._blendRotation(this._head, -0.04 + headBob + headVocal, -this._turnLean * 0.65 + Math.sin(this._phase * 0.7) * 0.06, 0.32);
            ...
            this._blendRotation(this._head, Math.sin(this._phase * 0.7) * 0.035 + headVocal, Math.sin(this._phase * 0.55) * 0.045 - this._turnLean * 0.5, 0.20);
