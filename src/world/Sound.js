...
export class SoundManager {
    ...
    _last = new Map();
    _master = null;
    _barkBuf = null; // ladrido real (audio/bark.mp3)
    getCtx() {
        if (this._ctx)
            return this._ctx;
