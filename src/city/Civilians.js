        ...
        for (let i = this.civs.length - 1; i >= 0; i--) {
            ...
            if (c.state === 'grabbed') {
                ...
                if (!z || !z.alive) {
                    ...
                    if (c.sprite) {
                        c.rig.group.remove(c.sprite);
                        c.sprite = null;
                    }
                    c.rig.group.rotation.z = 0;
                ...
                c.rig.legL.rotation.x = k;
                c.rig.legR.rotation.x = -k;
